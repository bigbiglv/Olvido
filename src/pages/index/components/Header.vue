...
<template>
  <header
    class="h-16 border-b border-slate-200 dark:border-zinc-800 flex items-center px-8 justify-center select-none bg-white/50 dark:bg-zinc-900/50 backdrop-blur-md shrink-0"
  >
    <!-- Search Bar Area -->
