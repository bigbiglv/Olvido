...
const { autoUpdateEnabled, isCheckingUpdate, downloadProgress, isDownloading, checkUpdate } =
  useAutoUpdater()
console.log('useAutoUpdater()', useAutoUpdater())
...
onMounted(async () => {
  ...
  try {
    const res = await fetch(
      `https://api.github.com/repos/bigbiglv/Olvido/releases/tags/v${version}`,
    )
    if (res.ok) {
    ...
    <div class="space-y-8">
      ...
      <section>
        <div class="flex items-center gap-2.5 px-1 mb-3">
          <div
            class="flex items-center justify-center size-7 rounded-lg bg-violet-100 dark:bg-violet-500/20 text-violet-600 dark:text-violet-400"
          >
      ...
      <section>
        <div class="flex items-center gap-2.5 px-1 mb-3">
          <div
            class="flex items-center justify-center size-7 rounded-lg bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400"
          >
